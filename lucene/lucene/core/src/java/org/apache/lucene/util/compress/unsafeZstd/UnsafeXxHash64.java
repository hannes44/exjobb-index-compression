...
import static org.apache.lucene.util.compress.unsafeZstd.UnsafeZSTDUtil.checkPositionIndexes;
import static java.lang.Long.rotateLeft;
import static java.lang.Math.min;
import static sun.misc.Unsafe.ARRAY_BYTE_BASE_OFFSET;

// forked from https://github.com/airlift/slice
final class UnsafeXxHash64
{
    ...
    public UnsafeXxHash64()
    {
        this(DEFAULT_SEED);
    }

    private UnsafeXxHash64(long seed)
    {
        this.seed = seed;
    ...
    public UnsafeXxHash64 update(byte[] data)
    {
        return update(data, 0, data.length);
    }

    public UnsafeXxHash64 update(byte[] data, int offset, int length)
    {
    ...
    public static long hash(long seed, InputStream in)
            throws IOException
    {
        UnsafeXxHash64 hash = new UnsafeXxHash64(seed);
