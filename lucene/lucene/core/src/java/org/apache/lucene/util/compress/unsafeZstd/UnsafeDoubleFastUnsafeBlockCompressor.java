...
class UnsafeDoubleFastUnsafeBlockCompressor
        implements UnsafeBlockCompressor
{
    private static final int MIN_MATCH = 3;
    private static final int SEARCH_STRENGTH = 8;
    private static final int REP_MOVE = UnsafeConstants.REPEATED_OFFSET_COUNT - 1;

    @Override
    public int compressBlock(Object inputBase, final long inputAddress, int inputSize, UnsafeSequenceStore output, UnsafeBlockCompressionState state, UnsafeRepeatedOffsets offsets, UnsafeCompressionParameters parameters)
    {
