 ...
 * @lucene.experimental
 */
public final class DeltaCompressionPostingsFormat extends PostingsFormat {
    ...
    public DeltaCompressionPostingsFormat() {
        this(
     ...
     */
    public DeltaCompressionPostingsFormat(int minTermBlockSize, int maxTermBlockSize) {
        super("SimpleText");
    ...
    public FieldsConsumer fieldsConsumer(SegmentWriteState state) throws IOException {
        PostingsWriterBase postingsWriter = new DeltaCompressionPostingsWriter(state);
    ...
    public FieldsProducer fieldsProducer(SegmentReadState state) throws IOException {
        PostingsReaderBase postingsReader = new DeltaCompressionPostingsReader(state);
        boolean success = false;
        try {
