...
import static org.apache.lucene.util.compress.unsafeSnappy.UnsafeSnappyConstants.*;
import static org.apache.lucene.util.UnsafeUtil.UNSAFE;

final class UnsafeSnappyRawDecompressor
{
    private static final int[] DEC_32_TABLE = {4, 1, 2, 1, 4, 4, 4, 4};
    private static final int[] DEC_64_TABLE = {0, 0, 0, -1, 0, 1, 2, 3};

    private UnsafeSnappyRawDecompressor() {}
