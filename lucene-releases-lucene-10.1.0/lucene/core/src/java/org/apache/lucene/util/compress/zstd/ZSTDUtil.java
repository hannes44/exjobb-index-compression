...
public final class ZSTDUtil
{
    ...
    public static int get24BitLittleEndian(DataInput inputBase, long inputAddress) throws IOException {
        return (inputBase.readShort() & 0xFFFF) | ((inputBase.readByte() & 0xFF) << Short.SIZE);
    }

    public static void put24BitLittleEndian(DataOutput outputBase, int value) throws IOException {
        outputBase.writeShort((short) value);
        outputBase.writeByte((byte) (value >>> Short.SIZE));
    }
