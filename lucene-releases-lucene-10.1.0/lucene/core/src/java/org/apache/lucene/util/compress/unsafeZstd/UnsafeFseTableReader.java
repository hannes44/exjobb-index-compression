...
import static org.apache.lucene.util.compress.unsafeZstd.UnsafeFiniteStateEntropy.MIN_TABLE_LOG;
...
public class UnsafeFseTableReader
{
    ...
    public int readFseTable(UnsafeFiniteStateEntropy.Table table, Object inputBase, long inputAddress, long inputLimit, int maxSymbol, int maxTableLog)
    {
        ...
        int position = UnsafeFseCompressionTable.spreadSymbols(normalizedCounters, maxSymbol, tableSize, highThreshold, table.symbol);
    ...
    public static void initializeRleTable(UnsafeFiniteStateEntropy.Table table, byte value)
    {
        table.log2Size = 0;
